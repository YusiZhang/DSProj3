...
public class Message implements Serializable{
	public static enum MSG_TYPE {
		...
		KEEP_ALIVE, NEW_JOB, JOB_COMP, JOB_FAIL, NEW_TASK,  NEW_MAP_TO_SLAVE, NEW_REDUCE_TO_SLAVE, MAPPER_SUCCESS, MAPPER_DONE, REDUCER_DONE, MAPRESULT_TO_REDUCE, NEW_MAPPER, NEW_REDUCER, GETFILE, FILEDOWNLOAD
	}
